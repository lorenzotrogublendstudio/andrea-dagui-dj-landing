          ...
          <div>
            ...
            <ul className="space-y-3 text-sm sm:text-base">
              {[
                ...
                <li key={index} className="text-gray-400 hover:text-[#d02894] transition-colors flex items-center gap-2 group cursor-pointer">
                  <svg className="w-4 h-4 text-[#d02894] opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-xs sm:text-sm">
              <a href="#" className="text-gray-400 hover:text-[#d02894] transition-colors">
                Privacy Policy
              </a>
